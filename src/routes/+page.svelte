			...
			<tbody>
				{#each dataPinjaman as sec, index}
					<tr>
						...
						<td>{sec.nama}</td>
						<td class="text-center align-middle">{sec.pinjaman}</td>
						<td class="text-center align-middle">{sec.dibayar}</td>
						<td class="text-center align-middle">{sec.pinjaman - sec.dibayar}</td>
					</tr>
				{/each}
			</tbody>
		</table>
